...
import {
  cancelGraphicSupplierQuoteAction, createGraphicSupplierQuoteAction,
...
import {
  canReadGraphicJobs, canWriteGraphicJobs, canWriteGraphicSupplierQuotes,
...
function quoteAuditLabel(action: string) { return ({ create: "Cotação criada", update: "Cotação atualizada", status_change: "Cotação cancelada" } as Record<string, string>)[action] ?? action; }
